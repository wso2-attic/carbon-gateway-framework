...
package org.wso2.carbon.gateway.core.flow.templates.uri.parser;

import java.util.Map;

/**
 * Abstract representation of an expression type.
 */
public abstract class Node {
    ...
    public abstract String expand(Map<String, String> variables);
    public abstract int match(String uriFragment, Map<String, String> variables);
