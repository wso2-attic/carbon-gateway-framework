...
public class IntegrationFlowTest {
    ...
    public void testIntegrationFlow()throws Exception {
        ...
        when(carbonMessage.getProperty(org.wso2.ballerina.core.Constants.SERVICE_CONTEXT)).thenReturn("/stocks");
        when(carbonMessage.getProperty(org.wso2.ballerina.core.Constants.SERVICE_SUB_GROUP_PATH)).
                thenReturn("/getStocks");
        when(carbonMessage.getProperty(org.wso2.ballerina.core.Constants.SERVICE_METHOD)).
                thenReturn("GET");
        when(carbonMessage.getProperty(org.wso2.ballerina.core.Constants.VARIABLE_STACK)).
