...
import org.wso2.ballerina.core.flow.mediators.builtin.invokers.CallMediator;
import org.wso2.ballerina.core.flow.mediators.builtin.invokers.RespondMediator;
...
public class WUMLListenerTest {
    ...
    class OutboundEndpoint implements org.wso2.ballerina.core.outbound.OutboundEndpoint {
