...
package org.wso2.ballerina.core.config.dsl.external.deployer;
...
import org.wso2.ballerina.core.config.dsl.external.wuml.WUMLBaseListenerImpl;
import org.wso2.ballerina.core.config.dsl.external.wuml.generated.WUMLLexer;
...
import static org.wso2.ballerina.core.Constants.EMPTY_STRING;
...
public class IFlowDeployer implements Deployer {
    ...
    @Reference(
            ...
            service = org.wso2.ballerina.core.inbound.ProviderRegistry.class,
            cardinality = ReferenceCardinality.MANDATORY,
            policy = ReferencePolicy.DYNAMIC,
            unbind = "removeInboundProviderRegistry")
    protected void addInboundProviderRegistry(org.wso2.ballerina.core.inbound.ProviderRegistry registry) {
    }

    protected void removeInboundProviderRegistry(org.wso2.ballerina.core.inbound.ProviderRegistry registry) {
    }

    @Reference(
            name = "outbound-provider-registry-service",
            service = org.wso2.ballerina.core.outbound.ProviderRegistry.class,
            cardinality = ReferenceCardinality.MANDATORY,
            policy = ReferencePolicy.DYNAMIC,
            unbind = "removeOutboundProviderRegistry")
    protected void addOutboundProviderRegistry(org.wso2.ballerina.core.outbound.ProviderRegistry registry) {
    }

    protected void removeOutboundProviderRegistry(org.wso2.ballerina.core.outbound.ProviderRegistry registry) {
    }

    @Reference(
            name = "mediator-provider-registry-service",
            service = org.wso2.ballerina.core.flow.ProviderRegistry.class,
            cardinality = ReferenceCardinality.MANDATORY,
            policy = ReferencePolicy.DYNAMIC,
            unbind = "removeMediatorProviderRegistry")
    protected void addMediatorProviderRegistry(org.wso2.ballerina.core.flow.ProviderRegistry registry) {
    }

    protected void removeMediatorProviderRegistry(org.wso2.ballerina.core.flow.ProviderRegistry registry) {
    }
