...
public class CallMediator extends AbstractMediator implements Invoker {
    ...
    public void setParameters(ParameterHolder parameterHolder) {
        if (parameterHolder.getParameter(org.wso2.ballerina.core.Constants.ENDPOINT_KEY) != null) {
            outboundEPKey = parameterHolder.getParameter(org.wso2.ballerina.core.Constants.ENDPOINT_KEY).getValue();
        } else {
            log.error(org.wso2.ballerina.core.Constants.ENDPOINT_KEY + " is not set in the configuration.");
        }
        if (parameterHolder.getParameter(org.wso2.ballerina.core.Constants.MESSAGE_KEY) != null) {
            messageKey = parameterHolder.getParameter(org.wso2.ballerina.core.Constants.MESSAGE_KEY).getValue();
        } else {
            log.error(org.wso2.ballerina.core.Constants.MESSAGE_KEY + " is not set in the configuration.");
        }
        if (parameterHolder.getParameter(org.wso2.ballerina.core.Constants.RETURN_VALUE) != null) {
            returnedOutput = parameterHolder.getParameter(org.wso2.ballerina.core.Constants.RETURN_VALUE).getValue();
        } else {
            log.error(org.wso2.ballerina.core.Constants.RETURN_VALUE + " is not set in the configuration.");
        }
        integrationKey = parameterHolder.getParameter(org.wso2.ballerina.core.Constants.INTEGRATION_KEY).getValue();
    }
